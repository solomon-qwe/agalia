...
HRESULT container_TIFF::loadBitmap(agaliaBitmap** ppBitmap) const
{
	return ::loadBitmap(ppBitmap, this);
}


HRESULT container_TIFF::loadThumbnail(agaliaBitmap** ppBitmap, uint32_t maxW, uint32_t maxH) const
{
