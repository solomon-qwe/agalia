...
HRESULT item_COM::getPropCount(uint32_t* count) const
{
...
HRESULT item_COM::getPropName(uint32_t index, agaliaString** str) const
{
...
HRESULT item_COM::getPropValue(uint32_t index, agaliaString** str) const
{
